<template>
	<div class="integralShopDetails">
		...
		<router-link :to="{name : 'outpatient_shopAddressAdd'  ,query : {address : JSON.stringify(address),time:new Date().getTime()}}">
		...
		<router-link :to="{name : 'outpatient_shopAddress' ,query : {address : JSON.stringify(address),time:new Date().getTime()}}">
			<div class="address" v-show="!!address.receiverId">
