<template>
  <div class="retrievePassword">
	<div class="navWarp">
		<a @click="goBackFn">
			<img src="../../static/新登陆-10.25/切图/shape@2x.png" alt="">
		</a>
		<span>修改密码</span>
	</div>
	<div class="center" v-model="retrieve">
		<ul>
			<li>
				<img class="iphone" src="../../static/新登陆-10.25/切图/iphone@2x.png" alt="">
				<input type="text" name='password' v-model="retrieve.telephone" maxlength="11"  oninput="value=value.replace(/[^\d]/g,'')" placeholder="请输入手机号">
			</li>
			<li>
				<img class="yanzhengma" src="../../static/新登陆-10.25/切图/yanzhengma@2x.png" alt="">
			...
			<li>
				<img class="mima" src="../../static/新登陆-10.25/切图/mima@2x.png" alt="">
...
.navWarp{
	...
	color: #FFFFFF;
	font-size: .2rem;
	background-image:url('../../static/新登陆-10.25/切图/BJ-change@2x.png');
