  ...
  methods: {
    ...
    nextPageFn(item){
      ...
      if(item.lowerCount){
        ...
        this.$router.push({name:'hospital_operatingManualListSeven',query:{name:item.name,operatingManualId:this.$route.query.operatingManualId,operatingManualSectionId : item.operatingManualSectionId,}})
      }else{
