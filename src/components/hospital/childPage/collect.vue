	...
	<div class="collect"  id='read' ref="Box"  @scroll="scrollToTop">
		<div class="topNav">
			<div class="return" @click="goBackFn">
				<img src="/src/assets/image/shape@3x.png" alt="">
			</div>
			<div class="searchInput">
				<img src="/src/assets/image/sousuo@2x.png" alt="">
				<input type="text" placeholder="搜索器械">
			</div>
			<div class="rightImg">
				<img src="/src/assets/image/shopping@2x.png" alt="">
				<img src="/src/assets/image/Import@2x.png" alt="">
			</div>
		</div>
		<div class="slide">
			<van-swipe >
			...
			<div class="contnet_right">
				<ul>
					<li v-for="(item,inx) in 99" :key='inx'>
						<img src="/src/assets/image/small-logo@2x.png" alt="">
						<div class="liRight">
							<h4>半自动体外除颤器</h4>
							<span>心脏骤停-分秒必争</span>
							<div class="nums">
